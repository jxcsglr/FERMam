...
from data_preprocessing.dataset_ferplus import FERPlusDataset  # NEW
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='ferplus', help='dataset: rafdb | affectnet | affectnet8class | ferplus')
    parser.add_argument('--ferplus_csv', type=str, default='/home/cdu-cs/jx/J/data/FERPLUS/FERPlus/fer2013new.csv', help='FERPlus CSV path')  #
    parser.add_argument('--ferplus_root', type=str, default='/home/cdu-cs/jx/J/data/FERPLUS/FERPlus', help='FERPlus images root')  #
...
def run_training():
    ...
    elif args.dataset == 'ferplus':  # NEW
        num_classes = 8
        train_ds = FERPlusDataset(args.ferplus_csv, args.ferplus_root, split='Training', transform=train_transforms)
        val_ds   = FERPlusDataset(args.ferplus_csv, args.ferplus_root, split='PublicTest', transform=val_transforms)
    else:
