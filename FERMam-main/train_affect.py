...
def parse_args():
    ...
    parser.add_argument('--val_batch_size', type=int, default=50, help='Validation batch size')
...
def run_training():
    ...
    if args.dataset == 'rafdb':
        ...
        num_classes = 8
        train_ds = Affectdataset_8class('/home/cdu-cs/jx/J/data/AffectNet/', train=True, transform=train_transforms, basic_aug=True)
        val_ds   = Affectdataset_8class('/home/cdu-cs/jx/J/data/AffectNet/', train=False, transform=val_transforms)
    else:
